...
function makeStickBinding(index /*: number*/) /*: IStickBinding*/ {
    return {
        index: index,
        mapper: function mapper(pad) {
...
var stickBindings /*: { [key: string]: IStickBinding }*/ = exports.stickBindings = (0, _tools.mapValues)(function (value) {
    return makeStickBinding(value);
}, stickIndexMapping);
