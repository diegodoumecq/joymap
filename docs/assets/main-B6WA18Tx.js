import"./modulepreload-polyfill-B5Qt9EMX.js";import{j as h,r as f,a as Pn,R as jn,b as Pt,c as jt}from"./client-vbRJSMsA.js";import{g as Ot}from"./_commonjsHelpers-Cpj98o6Y.js";const Lt=({isActive:e,children:n,className:t="",...r})=>h.jsx("button",{type:"button","aria-selected":e,className:`flex cursor-pointer items-center gap-1.5 rounded-md px-3 py-1.5 text-sm font-medium whitespace-nowrap uppercase transition-colors ${e?"bg-primary text-primary-foreground":"text-muted-foreground hover:bg-secondary hover:text-foreground"} ${t}`,...r,children:n}),Nt=e=>h.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",...e,children:h.jsx("path",{d:"M20 6 9 17l-5-5"})}),Tt=e=>h.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",...e,children:[h.jsx("rect",{width:"14",height:"14",x:"8",y:"8",rx:"2",ry:"2"}),h.jsx("path",{d:"M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2"})]});function It(e){const n=[],t=/\/\/.*$/gm;let r;for(;(r=t.exec(e))!==null;)n.push({start:r.index,end:r.index+r[0].length,className:"code-comment"});const o=/`(?:\\[\s\S]|\$\{[^}]*\}|[^`\\])*`|"(?:\\[\s\S]|[^"\\])*"|'(?:\\[\s\S]|[^'\\])*'/g;for(;(r=o.exec(e))!==null;)n.push({start:r.index,end:r.index+r[0].length,className:"code-string"});n.sort((l,s)=>l.start-s.start);let i="",a=0;for(const l of n){if(l.start<a)continue;const s=e.slice(a,l.start);i+=dn(s);const c=e.slice(l.start,l.end);i+=`<span class="${l.className}">${On(c)}</span>`,a=l.end}return i+=dn(e.slice(a)),i}function On(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function dn(e){let n=On(e);return n=n.replace(/\b(const|let|var|function|return|if|else|for|while|class|new|typeof|instanceof|async|await|import|export|default|from|throw|try|catch|finally|this|of|in)\b/g,'<span class="code-keyword">$1</span>'),n=n.replace(/\b(console|document|window|Promise|Array|Object|String|Number|Boolean|Map|Set|Proxy|Reflect|TypeError|RegExp|setTimeout|clearTimeout|undefined|null|true|false)\b/g,'<span class="code-builtin">$1</span>'),n=n.replace(/\b(\d+\.?\d*)\b/g,'<span class="code-number">$1</span>'),n=n.replace(/\.([a-zA-Z_]\w*)(\s*\()/g,'.<span class="code-method">$1</span>$2'),n=n.replace(/\b([a-zA-Z_]\w*)(\s*\()/g,(t,r,o)=>t.includes('class="')?t:`<span class="code-function">${r}</span>${o}`),n=n.replace(/=&gt;/g,'<span class="code-keyword">=&gt;</span>'),n}function Dt({code:e}){const[n,t]=f.useState(!1),r=f.useRef(null);f.useEffect(()=>{r.current&&(r.current.innerHTML=It(e))},[e]);const o=async()=>{await navigator.clipboard.writeText(e),t(!0),setTimeout(()=>t(!1),2e3)};return h.jsxs("div",{className:"group relative overflow-hidden rounded-lg border border-border bg-secondary/50",children:[h.jsxs("div",{className:"flex items-center justify-between border-b border-border bg-secondary/80 px-4 py-2",children:[h.jsx("span",{className:"font-mono text-xs text-muted-foreground",children:"Javascript"}),h.jsx("button",{onClick:o,className:"flex items-center gap-1.5 text-xs text-muted-foreground transition-colors hover:text-foreground","aria-label":"Copy code",children:n?h.jsxs(h.Fragment,{children:[h.jsx(Nt,{className:"h-3.5 w-3.5"}),h.jsx("span",{children:"Copied"})]}):h.jsxs(h.Fragment,{children:[h.jsx(Tt,{className:"h-3.5 w-3.5"}),h.jsx("span",{children:"Copy"})]})})]}),h.jsx("div",{className:"overflow-x-auto p-4",children:h.jsx("pre",{className:"text-sm leading-relaxed",children:h.jsx("code",{ref:r,className:"font-mono"})})})]})}function Y(e,n,{checkForDefaultPrevented:t=!0}={}){return function(o){if(e==null||e(o),t===!1||!o.defaultPrevented)return n==null?void 0:n(o)}}function un(e,n){if(typeof e=="function")return e(n);e!=null&&(e.current=n)}function Ln(...e){return n=>{let t=!1;const r=e.map(o=>{const i=un(o,n);return!t&&typeof i=="function"&&(t=!0),i});if(t)return()=>{for(let o=0;o<r.length;o++){const i=r[o];typeof i=="function"?i():un(e[o],null)}}}}function ie(...e){return f.useCallback(Ln(...e),e)}function Nn(e,n=[]){let t=[];function r(i,a){const l=f.createContext(a),s=t.length;t=[...t,a];const c=u=>{var v;const{scope:p,children:m,...x}=u,w=((v=p==null?void 0:p[e])==null?void 0:v[s])||l,C=f.useMemo(()=>x,Object.values(x));return h.jsx(w.Provider,{value:C,children:m})};c.displayName=i+"Provider";function d(u,p){var w;const m=((w=p==null?void 0:p[e])==null?void 0:w[s])||l,x=f.useContext(m);if(x)return x;if(a!==void 0)return a;throw new Error(`\`${u}\` must be used within \`${i}\``)}return[c,d]}const o=()=>{const i=t.map(a=>f.createContext(a));return function(l){const s=(l==null?void 0:l[e])||i;return f.useMemo(()=>({[`__scope${e}`]:{...l,[e]:s}}),[l,s])}};return o.scopeName=e,[r,Bt(o,...n)]}function Bt(...e){const n=e[0];if(e.length===1)return n;const t=()=>{const r=e.map(o=>({useScope:o(),scopeName:o.scopeName}));return function(i){const a=r.reduce((l,{useScope:s,scopeName:c})=>{const u=s(i)[`__scope${c}`];return{...l,...u}},{});return f.useMemo(()=>({[`__scope${n.scopeName}`]:a}),[a])}};return t.scopeName=n.scopeName,t}function $t(e){const n=Ft(e),t=f.forwardRef((r,o)=>{const{children:i,...a}=r,l=f.Children.toArray(i),s=l.find(Ht);if(s){const c=s.props.children,d=l.map(u=>u===s?f.Children.count(c)>1?f.Children.only(null):f.isValidElement(c)?c.props.children:null:u);return h.jsx(n,{...a,ref:o,children:f.isValidElement(c)?f.cloneElement(c,void 0,d):null})}return h.jsx(n,{...a,ref:o,children:i})});return t.displayName=`${e}.Slot`,t}function Ft(e){const n=f.forwardRef((t,r)=>{const{children:o,...i}=t;if(f.isValidElement(o)){const a=Ut(o),l=Wt(i,o.props);return o.type!==f.Fragment&&(l.ref=r?Ln(r,a):a),f.cloneElement(o,l)}return f.Children.count(o)>1?f.Children.only(null):null});return n.displayName=`${e}.SlotClone`,n}var Tn=Symbol("radix.slottable");function _t(e){const n=({children:t})=>h.jsx(h.Fragment,{children:t});return n.displayName=`${e}.Slottable`,n.__radixId=Tn,n}function Ht(e){return f.isValidElement(e)&&typeof e.type=="function"&&"__radixId"in e.type&&e.type.__radixId===Tn}function Wt(e,n){const t={...n};for(const r in n){const o=e[r],i=n[r];/^on[A-Z]/.test(r)?o&&i?t[r]=(...l)=>{const s=i(...l);return o(...l),s}:o&&(t[r]=o):r==="style"?t[r]={...o,...i}:r==="className"&&(t[r]=[o,i].filter(Boolean).join(" "))}return{...e,...t}}function Ut(e){var r,o;let n=(r=Object.getOwnPropertyDescriptor(e.props,"ref"))==null?void 0:r.get,t=n&&"isReactWarning"in n&&n.isReactWarning;return t?e.ref:(n=(o=Object.getOwnPropertyDescriptor(e,"ref"))==null?void 0:o.get,t=n&&"isReactWarning"in n&&n.isReactWarning,t?e.props.ref:e.props.ref||e.ref)}var zt=["a","button","div","form","h2","h3","img","input","label","li","nav","ol","p","select","span","svg","ul"],ne=zt.reduce((e,n)=>{const t=$t(`Primitive.${n}`),r=f.forwardRef((o,i)=>{const{asChild:a,...l}=o,s=a?t:n;return typeof window<"u"&&(window[Symbol.for("radix-ui")]=!0),h.jsx(s,{...l,ref:i})});return r.displayName=`Primitive.${n}`,{...e,[n]:r}},{});function Xt(e,n){e&&Pn.flushSync(()=>e.dispatchEvent(n))}function Ae(e){const n=f.useRef(e);return f.useEffect(()=>{n.current=e}),f.useMemo(()=>(...t)=>{var r;return(r=n.current)==null?void 0:r.call(n,...t)},[])}function Zt(e,n=globalThis==null?void 0:globalThis.document){const t=Ae(e);f.useEffect(()=>{const r=o=>{o.key==="Escape"&&t(o)};return n.addEventListener("keydown",r,{capture:!0}),()=>n.removeEventListener("keydown",r,{capture:!0})},[t,n])}var Yt="DismissableLayer",$e="dismissableLayer.update",Jt="dismissableLayer.pointerDownOutside",Vt="dismissableLayer.focusOutside",pn,In=f.createContext({layers:new Set,layersWithOutsidePointerEventsDisabled:new Set,branches:new Set}),Dn=f.forwardRef((e,n)=>{const{disableOutsidePointerEvents:t=!1,onEscapeKeyDown:r,onPointerDownOutside:o,onFocusOutside:i,onInteractOutside:a,onDismiss:l,...s}=e,c=f.useContext(In),[d,u]=f.useState(null),p=(d==null?void 0:d.ownerDocument)??(globalThis==null?void 0:globalThis.document),[,m]=f.useState({}),x=ie(n,y=>u(y)),w=Array.from(c.layers),[C]=[...c.layersWithOutsidePointerEventsDisabled].slice(-1),v=w.indexOf(C),k=d?w.indexOf(d):-1,R=c.layersWithOutsidePointerEventsDisabled.size>0,b=k>=v,S=Gt(y=>{const E=y.target,N=[...c.branches].some(A=>A.contains(E));!b||N||(o==null||o(y),a==null||a(y),y.defaultPrevented||l==null||l())},p),g=Kt(y=>{const E=y.target;[...c.branches].some(A=>A.contains(E))||(i==null||i(y),a==null||a(y),y.defaultPrevented||l==null||l())},p);return Zt(y=>{k===c.layers.size-1&&(r==null||r(y),!y.defaultPrevented&&l&&(y.preventDefault(),l()))},p),f.useEffect(()=>{if(d)return t&&(c.layersWithOutsidePointerEventsDisabled.size===0&&(pn=p.body.style.pointerEvents,p.body.style.pointerEvents="none"),c.layersWithOutsidePointerEventsDisabled.add(d)),c.layers.add(d),fn(),()=>{t&&c.layersWithOutsidePointerEventsDisabled.size===1&&(p.body.style.pointerEvents=pn)}},[d,p,t,c]),f.useEffect(()=>()=>{d&&(c.layers.delete(d),c.layersWithOutsidePointerEventsDisabled.delete(d),fn())},[d,c]),f.useEffect(()=>{const y=()=>m({});return document.addEventListener($e,y),()=>document.removeEventListener($e,y)},[]),h.jsx(ne.div,{...s,ref:x,style:{pointerEvents:R?b?"auto":"none":void 0,...e.style},onFocusCapture:Y(e.onFocusCapture,g.onFocusCapture),onBlurCapture:Y(e.onBlurCapture,g.onBlurCapture),onPointerDownCapture:Y(e.onPointerDownCapture,S.onPointerDownCapture)})});Dn.displayName=Yt;var qt="DismissableLayerBranch",Qt=f.forwardRef((e,n)=>{const t=f.useContext(In),r=f.useRef(null),o=ie(n,r);return f.useEffect(()=>{const i=r.current;if(i)return t.branches.add(i),()=>{t.branches.delete(i)}},[t.branches]),h.jsx(ne.div,{...e,ref:o})});Qt.displayName=qt;function Gt(e,n=globalThis==null?void 0:globalThis.document){const t=Ae(e),r=f.useRef(!1),o=f.useRef(()=>{});return f.useEffect(()=>{const i=l=>{if(l.target&&!r.current){let s=function(){Bn(Jt,t,c,{discrete:!0})};const c={originalEvent:l};l.pointerType==="touch"?(n.removeEventListener("click",o.current),o.current=s,n.addEventListener("click",o.current,{once:!0})):s()}else n.removeEventListener("click",o.current);r.current=!1},a=window.setTimeout(()=>{n.addEventListener("pointerdown",i)},0);return()=>{window.clearTimeout(a),n.removeEventListener("pointerdown",i),n.removeEventListener("click",o.current)}},[n,t]),{onPointerDownCapture:()=>r.current=!0}}function Kt(e,n=globalThis==null?void 0:globalThis.document){const t=Ae(e),r=f.useRef(!1);return f.useEffect(()=>{const o=i=>{i.target&&!r.current&&Bn(Vt,t,{originalEvent:i},{discrete:!1})};return n.addEventListener("focusin",o),()=>n.removeEventListener("focusin",o)},[n,t]),{onFocusCapture:()=>r.current=!0,onBlurCapture:()=>r.current=!1}}function fn(){const e=new CustomEvent($e);document.dispatchEvent(e)}function Bn(e,n,t,{discrete:r}){const o=t.originalEvent.target,i=new CustomEvent(e,{bubbles:!1,cancelable:!0,detail:t});n&&o.addEventListener(e,n,{once:!0}),r?Xt(o,i):o.dispatchEvent(i)}var G=globalThis!=null&&globalThis.document?f.useLayoutEffect:()=>{},er=jn[" useId ".trim().toString()]||(()=>{}),nr=0;function tr(e){const[n,t]=f.useState(er());return G(()=>{t(r=>r??String(nr++))},[e]),n?`radix-${n}`:""}const rr=["top","right","bottom","left"],K=Math.min,$=Math.max,Ee=Math.round,be=Math.floor,X=e=>({x:e,y:e}),or={left:"right",right:"left",bottom:"top",top:"bottom"};function Fe(e,n,t){return $(e,K(n,t))}function J(e,n){return typeof e=="function"?e(n):e}function V(e){return e.split("-")[0]}function le(e){return e.split("-")[1]}function ze(e){return e==="x"?"y":"x"}function Xe(e){return e==="y"?"height":"width"}function z(e){const n=e[0];return n==="t"||n==="b"?"y":"x"}function Ze(e){return ze(z(e))}function ir(e,n,t){t===void 0&&(t=!1);const r=le(e),o=Ze(e),i=Xe(o);let a=o==="x"?r===(t?"end":"start")?"right":"left":r==="start"?"bottom":"top";return n.reference[i]>n.floating[i]&&(a=Re(a)),[a,Re(a)]}function sr(e){const n=Re(e);return[_e(e),n,_e(n)]}function _e(e){return e.includes("start")?e.replace("start","end"):e.replace("end","start")}const mn=["left","right"],hn=["right","left"],ar=["top","bottom"],cr=["bottom","top"];function lr(e,n,t){switch(e){case"top":case"bottom":return t?n?hn:mn:n?mn:hn;case"left":case"right":return n?ar:cr;default:return[]}}function dr(e,n,t,r){const o=le(e);let i=lr(V(e),t==="start",r);return o&&(i=i.map(a=>a+"-"+o),n&&(i=i.concat(i.map(_e)))),i}function Re(e){const n=V(e);return or[n]+e.slice(n.length)}function ur(e){return{top:0,right:0,bottom:0,left:0,...e}}function $n(e){return typeof e!="number"?ur(e):{top:e,right:e,bottom:e,left:e}}function Se(e){const{x:n,y:t,width:r,height:o}=e;return{width:r,height:o,top:t,left:n,right:n+r,bottom:t+o,x:n,y:t}}function gn(e,n,t){let{reference:r,floating:o}=e;const i=z(n),a=Ze(n),l=Xe(a),s=V(n),c=i==="y",d=r.x+r.width/2-o.width/2,u=r.y+r.height/2-o.height/2,p=r[l]/2-o[l]/2;let m;switch(s){case"top":m={x:d,y:r.y-o.height};break;case"bottom":m={x:d,y:r.y+r.height};break;case"right":m={x:r.x+r.width,y:u};break;case"left":m={x:r.x-o.width,y:u};break;default:m={x:r.x,y:r.y}}switch(le(n)){case"start":m[a]-=p*(t&&c?-1:1);break;case"end":m[a]+=p*(t&&c?-1:1);break}return m}async function pr(e,n){var t;n===void 0&&(n={});const{x:r,y:o,platform:i,rects:a,elements:l,strategy:s}=e,{boundary:c="clippingAncestors",rootBoundary:d="viewport",elementContext:u="floating",altBoundary:p=!1,padding:m=0}=J(n,e),x=$n(m),C=l[p?u==="floating"?"reference":"floating":u],v=Se(await i.getClippingRect({element:(t=await(i.isElement==null?void 0:i.isElement(C)))==null||t?C:C.contextElement||await(i.getDocumentElement==null?void 0:i.getDocumentElement(l.floating)),boundary:c,rootBoundary:d,strategy:s})),k=u==="floating"?{x:r,y:o,width:a.floating.width,height:a.floating.height}:a.reference,R=await(i.getOffsetParent==null?void 0:i.getOffsetParent(l.floating)),b=await(i.isElement==null?void 0:i.isElement(R))?await(i.getScale==null?void 0:i.getScale(R))||{x:1,y:1}:{x:1,y:1},S=Se(i.convertOffsetParentRelativeRectToViewportRelativeRect?await i.convertOffsetParentRelativeRectToViewportRelativeRect({elements:l,rect:k,offsetParent:R,strategy:s}):k);return{top:(v.top-S.top+x.top)/b.y,bottom:(S.bottom-v.bottom+x.bottom)/b.y,left:(v.left-S.left+x.left)/b.x,right:(S.right-v.right+x.right)/b.x}}const fr=50,mr=async(e,n,t)=>{const{placement:r="bottom",strategy:o="absolute",middleware:i=[],platform:a}=t,l=a.detectOverflow?a:{...a,detectOverflow:pr},s=await(a.isRTL==null?void 0:a.isRTL(n));let c=await a.getElementRects({reference:e,floating:n,strategy:o}),{x:d,y:u}=gn(c,r,s),p=r,m=0;const x={};for(let w=0;w<i.length;w++){const C=i[w];if(!C)continue;const{name:v,fn:k}=C,{x:R,y:b,data:S,reset:g}=await k({x:d,y:u,initialPlacement:r,placement:p,strategy:o,middlewareData:x,rects:c,platform:l,elements:{reference:e,floating:n}});d=R??d,u=b??u,x[v]={...x[v],...S},g&&m<fr&&(m++,typeof g=="object"&&(g.placement&&(p=g.placement),g.rects&&(c=g.rects===!0?await a.getElementRects({reference:e,floating:n,strategy:o}):g.rects),{x:d,y:u}=gn(c,p,s)),w=-1)}return{x:d,y:u,placement:p,strategy:o,middlewareData:x}},hr=e=>({name:"arrow",options:e,async fn(n){const{x:t,y:r,placement:o,rects:i,platform:a,elements:l,middlewareData:s}=n,{element:c,padding:d=0}=J(e,n)||{};if(c==null)return{};const u=$n(d),p={x:t,y:r},m=Ze(o),x=Xe(m),w=await a.getDimensions(c),C=m==="y",v=C?"top":"left",k=C?"bottom":"right",R=C?"clientHeight":"clientWidth",b=i.reference[x]+i.reference[m]-p[m]-i.floating[x],S=p[m]-i.reference[m],g=await(a.getOffsetParent==null?void 0:a.getOffsetParent(c));let y=g?g[R]:0;(!y||!await(a.isElement==null?void 0:a.isElement(g)))&&(y=l.floating[R]||i.floating[x]);const E=b/2-S/2,N=y/2-w[x]/2-1,A=K(u[v],N),I=K(u[k],N),D=A,j=y-w[x]-I,P=y/2-w[x]/2+E,B=Fe(D,P,j),O=!s.arrow&&le(o)!=null&&P!==B&&i.reference[x]/2-(P<D?A:I)-w[x]/2<0,L=O?P<D?P-D:P-j:0;return{[m]:p[m]+L,data:{[m]:B,centerOffset:P-B-L,...O&&{alignmentOffset:L}},reset:O}}}),gr=function(e){return e===void 0&&(e={}),{name:"flip",options:e,async fn(n){var t,r;const{placement:o,middlewareData:i,rects:a,initialPlacement:l,platform:s,elements:c}=n,{mainAxis:d=!0,crossAxis:u=!0,fallbackPlacements:p,fallbackStrategy:m="bestFit",fallbackAxisSideDirection:x="none",flipAlignment:w=!0,...C}=J(e,n);if((t=i.arrow)!=null&&t.alignmentOffset)return{};const v=V(o),k=z(l),R=V(l)===l,b=await(s.isRTL==null?void 0:s.isRTL(c.floating)),S=p||(R||!w?[Re(l)]:sr(l)),g=x!=="none";!p&&g&&S.push(...dr(l,w,x,b));const y=[l,...S],E=await s.detectOverflow(n,C),N=[];let A=((r=i.flip)==null?void 0:r.overflows)||[];if(d&&N.push(E[v]),u){const P=ir(o,a,b);N.push(E[P[0]],E[P[1]])}if(A=[...A,{placement:o,overflows:N}],!N.every(P=>P<=0)){var I,D;const P=(((I=i.flip)==null?void 0:I.index)||0)+1,B=y[P];if(B&&(!(u==="alignment"?k!==z(B):!1)||A.every(M=>z(M.placement)===k?M.overflows[0]>0:!0)))return{data:{index:P,overflows:A},reset:{placement:B}};let O=(D=A.filter(L=>L.overflows[0]<=0).sort((L,M)=>L.overflows[1]-M.overflows[1])[0])==null?void 0:D.placement;if(!O)switch(m){case"bestFit":{var j;const L=(j=A.filter(M=>{if(g){const T=z(M.placement);return T===k||T==="y"}return!0}).map(M=>[M.placement,M.overflows.filter(T=>T>0).reduce((T,U)=>T+U,0)]).sort((M,T)=>M[1]-T[1])[0])==null?void 0:j[0];L&&(O=L);break}case"initialPlacement":O=l;break}if(o!==O)return{reset:{placement:O}}}return{}}}};function xn(e,n){return{top:e.top-n.height,right:e.right-n.width,bottom:e.bottom-n.height,left:e.left-n.width}}function yn(e){return rr.some(n=>e[n]>=0)}const xr=function(e){return e===void 0&&(e={}),{name:"hide",options:e,async fn(n){const{rects:t,platform:r}=n,{strategy:o="referenceHidden",...i}=J(e,n);switch(o){case"referenceHidden":{const a=await r.detectOverflow(n,{...i,elementContext:"reference"}),l=xn(a,t.reference);return{data:{referenceHiddenOffsets:l,referenceHidden:yn(l)}}}case"escaped":{const a=await r.detectOverflow(n,{...i,altBoundary:!0}),l=xn(a,t.floating);return{data:{escapedOffsets:l,escaped:yn(l)}}}default:return{}}}}},Fn=new Set(["left","top"]);async function yr(e,n){const{placement:t,platform:r,elements:o}=e,i=await(r.isRTL==null?void 0:r.isRTL(o.floating)),a=V(t),l=le(t),s=z(t)==="y",c=Fn.has(a)?-1:1,d=i&&s?-1:1,u=J(n,e);let{mainAxis:p,crossAxis:m,alignmentAxis:x}=typeof u=="number"?{mainAxis:u,crossAxis:0,alignmentAxis:null}:{mainAxis:u.mainAxis||0,crossAxis:u.crossAxis||0,alignmentAxis:u.alignmentAxis};return l&&typeof x=="number"&&(m=l==="end"?x*-1:x),s?{x:m*d,y:p*c}:{x:p*c,y:m*d}}const wr=function(e){return e===void 0&&(e=0),{name:"offset",options:e,async fn(n){var t,r;const{x:o,y:i,placement:a,middlewareData:l}=n,s=await yr(n,e);return a===((t=l.offset)==null?void 0:t.placement)&&(r=l.arrow)!=null&&r.alignmentOffset?{}:{x:o+s.x,y:i+s.y,data:{...s,placement:a}}}}},vr=function(e){return e===void 0&&(e={}),{name:"shift",options:e,async fn(n){const{x:t,y:r,placement:o,platform:i}=n,{mainAxis:a=!0,crossAxis:l=!1,limiter:s={fn:v=>{let{x:k,y:R}=v;return{x:k,y:R}}},...c}=J(e,n),d={x:t,y:r},u=await i.detectOverflow(n,c),p=z(V(o)),m=ze(p);let x=d[m],w=d[p];if(a){const v=m==="y"?"top":"left",k=m==="y"?"bottom":"right",R=x+u[v],b=x-u[k];x=Fe(R,x,b)}if(l){const v=p==="y"?"top":"left",k=p==="y"?"bottom":"right",R=w+u[v],b=w-u[k];w=Fe(R,w,b)}const C=s.fn({...n,[m]:x,[p]:w});return{...C,data:{x:C.x-t,y:C.y-r,enabled:{[m]:a,[p]:l}}}}}},br=function(e){return e===void 0&&(e={}),{options:e,fn(n){const{x:t,y:r,placement:o,rects:i,middlewareData:a}=n,{offset:l=0,mainAxis:s=!0,crossAxis:c=!0}=J(e,n),d={x:t,y:r},u=z(o),p=ze(u);let m=d[p],x=d[u];const w=J(l,n),C=typeof w=="number"?{mainAxis:w,crossAxis:0}:{mainAxis:0,crossAxis:0,...w};if(s){const R=p==="y"?"height":"width",b=i.reference[p]-i.floating[R]+C.mainAxis,S=i.reference[p]+i.reference[R]-C.mainAxis;m<b?m=b:m>S&&(m=S)}if(c){var v,k;const R=p==="y"?"width":"height",b=Fn.has(V(o)),S=i.reference[u]-i.floating[R]+(b&&((v=a.offset)==null?void 0:v[u])||0)+(b?0:C.crossAxis),g=i.reference[u]+i.reference[R]+(b?0:((k=a.offset)==null?void 0:k[u])||0)-(b?C.crossAxis:0);x<S?x=S:x>g&&(x=g)}return{[p]:m,[u]:x}}}},kr=function(e){return e===void 0&&(e={}),{name:"size",options:e,async fn(n){var t,r;const{placement:o,rects:i,platform:a,elements:l}=n,{apply:s=()=>{},...c}=J(e,n),d=await a.detectOverflow(n,c),u=V(o),p=le(o),m=z(o)==="y",{width:x,height:w}=i.floating;let C,v;u==="top"||u==="bottom"?(C=u,v=p===(await(a.isRTL==null?void 0:a.isRTL(l.floating))?"start":"end")?"left":"right"):(v=u,C=p==="end"?"top":"bottom");const k=w-d.top-d.bottom,R=x-d.left-d.right,b=K(w-d[C],k),S=K(x-d[v],R),g=!n.middlewareData.shift;let y=b,E=S;if((t=n.middlewareData.shift)!=null&&t.enabled.x&&(E=R),(r=n.middlewareData.shift)!=null&&r.enabled.y&&(y=k),g&&!p){const A=$(d.left,0),I=$(d.right,0),D=$(d.top,0),j=$(d.bottom,0);m?E=x-2*(A!==0||I!==0?A+I:$(d.left,d.right)):y=w-2*(D!==0||j!==0?D+j:$(d.top,d.bottom))}await s({...n,availableWidth:E,availableHeight:y});const N=await a.getDimensions(l.floating);return x!==N.width||w!==N.height?{reset:{rects:!0}}:{}}}};function Pe(){return typeof window<"u"}function de(e){return _n(e)?(e.nodeName||"").toLowerCase():"#document"}function F(e){var n;return(e==null||(n=e.ownerDocument)==null?void 0:n.defaultView)||window}function Z(e){var n;return(n=(_n(e)?e.ownerDocument:e.document)||window.document)==null?void 0:n.documentElement}function _n(e){return Pe()?e instanceof Node||e instanceof F(e).Node:!1}function H(e){return Pe()?e instanceof Element||e instanceof F(e).Element:!1}function q(e){return Pe()?e instanceof HTMLElement||e instanceof F(e).HTMLElement:!1}function wn(e){return!Pe()||typeof ShadowRoot>"u"?!1:e instanceof ShadowRoot||e instanceof F(e).ShadowRoot}function he(e){const{overflow:n,overflowX:t,overflowY:r,display:o}=W(e);return/auto|scroll|overlay|hidden|clip/.test(n+r+t)&&o!=="inline"&&o!=="contents"}function Cr(e){return/^(table|td|th)$/.test(de(e))}function je(e){try{if(e.matches(":popover-open"))return!0}catch{}try{return e.matches(":modal")}catch{return!1}}const Er=/transform|translate|scale|rotate|perspective|filter/,Rr=/paint|layout|strict|content/,te=e=>!!e&&e!=="none";let Ie;function Ye(e){const n=H(e)?W(e):e;return te(n.transform)||te(n.translate)||te(n.scale)||te(n.rotate)||te(n.perspective)||!Je()&&(te(n.backdropFilter)||te(n.filter))||Er.test(n.willChange||"")||Rr.test(n.contain||"")}function Sr(e){let n=ee(e);for(;q(n)&&!ae(n);){if(Ye(n))return n;if(je(n))return null;n=ee(n)}return null}function Je(){return Ie==null&&(Ie=typeof CSS<"u"&&CSS.supports&&CSS.supports("-webkit-backdrop-filter","none")),Ie}function ae(e){return/^(html|body|#document)$/.test(de(e))}function W(e){return F(e).getComputedStyle(e)}function Oe(e){return H(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.scrollX,scrollTop:e.scrollY}}function ee(e){if(de(e)==="html")return e;const n=e.assignedSlot||e.parentNode||wn(e)&&e.host||Z(e);return wn(n)?n.host:n}function Hn(e){const n=ee(e);return ae(n)?e.ownerDocument?e.ownerDocument.body:e.body:q(n)&&he(n)?n:Hn(n)}function fe(e,n,t){var r;n===void 0&&(n=[]),t===void 0&&(t=!0);const o=Hn(e),i=o===((r=e.ownerDocument)==null?void 0:r.body),a=F(o);if(i){const l=He(a);return n.concat(a,a.visualViewport||[],he(o)?o:[],l&&t?fe(l):[])}else return n.concat(o,fe(o,[],t))}function He(e){return e.parent&&Object.getPrototypeOf(e.parent)?e.frameElement:null}function Wn(e){const n=W(e);let t=parseFloat(n.width)||0,r=parseFloat(n.height)||0;const o=q(e),i=o?e.offsetWidth:t,a=o?e.offsetHeight:r,l=Ee(t)!==i||Ee(r)!==a;return l&&(t=i,r=a),{width:t,height:r,$:l}}function Ve(e){return H(e)?e:e.contextElement}function se(e){const n=Ve(e);if(!q(n))return X(1);const t=n.getBoundingClientRect(),{width:r,height:o,$:i}=Wn(n);let a=(i?Ee(t.width):t.width)/r,l=(i?Ee(t.height):t.height)/o;return(!a||!Number.isFinite(a))&&(a=1),(!l||!Number.isFinite(l))&&(l=1),{x:a,y:l}}const Mr=X(0);function Un(e){const n=F(e);return!Je()||!n.visualViewport?Mr:{x:n.visualViewport.offsetLeft,y:n.visualViewport.offsetTop}}function Ar(e,n,t){return n===void 0&&(n=!1),!t||n&&t!==F(e)?!1:n}function oe(e,n,t,r){n===void 0&&(n=!1),t===void 0&&(t=!1);const o=e.getBoundingClientRect(),i=Ve(e);let a=X(1);n&&(r?H(r)&&(a=se(r)):a=se(e));const l=Ar(i,t,r)?Un(i):X(0);let s=(o.left+l.x)/a.x,c=(o.top+l.y)/a.y,d=o.width/a.x,u=o.height/a.y;if(i){const p=F(i),m=r&&H(r)?F(r):r;let x=p,w=He(x);for(;w&&r&&m!==x;){const C=se(w),v=w.getBoundingClientRect(),k=W(w),R=v.left+(w.clientLeft+parseFloat(k.paddingLeft))*C.x,b=v.top+(w.clientTop+parseFloat(k.paddingTop))*C.y;s*=C.x,c*=C.y,d*=C.x,u*=C.y,s+=R,c+=b,x=F(w),w=He(x)}}return Se({width:d,height:u,x:s,y:c})}function Le(e,n){const t=Oe(e).scrollLeft;return n?n.left+t:oe(Z(e)).left+t}function zn(e,n){const t=e.getBoundingClientRect(),r=t.left+n.scrollLeft-Le(e,t),o=t.top+n.scrollTop;return{x:r,y:o}}function Pr(e){let{elements:n,rect:t,offsetParent:r,strategy:o}=e;const i=o==="fixed",a=Z(r),l=n?je(n.floating):!1;if(r===a||l&&i)return t;let s={scrollLeft:0,scrollTop:0},c=X(1);const d=X(0),u=q(r);if((u||!u&&!i)&&((de(r)!=="body"||he(a))&&(s=Oe(r)),u)){const m=oe(r);c=se(r),d.x=m.x+r.clientLeft,d.y=m.y+r.clientTop}const p=a&&!u&&!i?zn(a,s):X(0);return{width:t.width*c.x,height:t.height*c.y,x:t.x*c.x-s.scrollLeft*c.x+d.x+p.x,y:t.y*c.y-s.scrollTop*c.y+d.y+p.y}}function jr(e){return Array.from(e.getClientRects())}function Or(e){const n=Z(e),t=Oe(e),r=e.ownerDocument.body,o=$(n.scrollWidth,n.clientWidth,r.scrollWidth,r.clientWidth),i=$(n.scrollHeight,n.clientHeight,r.scrollHeight,r.clientHeight);let a=-t.scrollLeft+Le(e);const l=-t.scrollTop;return W(r).direction==="rtl"&&(a+=$(n.clientWidth,r.clientWidth)-o),{width:o,height:i,x:a,y:l}}const vn=25;function Lr(e,n){const t=F(e),r=Z(e),o=t.visualViewport;let i=r.clientWidth,a=r.clientHeight,l=0,s=0;if(o){i=o.width,a=o.height;const d=Je();(!d||d&&n==="fixed")&&(l=o.offsetLeft,s=o.offsetTop)}const c=Le(r);if(c<=0){const d=r.ownerDocument,u=d.body,p=getComputedStyle(u),m=d.compatMode==="CSS1Compat"&&parseFloat(p.marginLeft)+parseFloat(p.marginRight)||0,x=Math.abs(r.clientWidth-u.clientWidth-m);x<=vn&&(i-=x)}else c<=vn&&(i+=c);return{width:i,height:a,x:l,y:s}}function Nr(e,n){const t=oe(e,!0,n==="fixed"),r=t.top+e.clientTop,o=t.left+e.clientLeft,i=q(e)?se(e):X(1),a=e.clientWidth*i.x,l=e.clientHeight*i.y,s=o*i.x,c=r*i.y;return{width:a,height:l,x:s,y:c}}function bn(e,n,t){let r;if(n==="viewport")r=Lr(e,t);else if(n==="document")r=Or(Z(e));else if(H(n))r=Nr(n,t);else{const o=Un(e);r={x:n.x-o.x,y:n.y-o.y,width:n.width,height:n.height}}return Se(r)}function Xn(e,n){const t=ee(e);return t===n||!H(t)||ae(t)?!1:W(t).position==="fixed"||Xn(t,n)}function Tr(e,n){const t=n.get(e);if(t)return t;let r=fe(e,[],!1).filter(l=>H(l)&&de(l)!=="body"),o=null;const i=W(e).position==="fixed";let a=i?ee(e):e;for(;H(a)&&!ae(a);){const l=W(a),s=Ye(a);!s&&l.position==="fixed"&&(o=null),(i?!s&&!o:!s&&l.position==="static"&&!!o&&(o.position==="absolute"||o.position==="fixed")||he(a)&&!s&&Xn(e,a))?r=r.filter(d=>d!==a):o=l,a=ee(a)}return n.set(e,r),r}function Ir(e){let{element:n,boundary:t,rootBoundary:r,strategy:o}=e;const a=[...t==="clippingAncestors"?je(n)?[]:Tr(n,this._c):[].concat(t),r],l=bn(n,a[0],o);let s=l.top,c=l.right,d=l.bottom,u=l.left;for(let p=1;p<a.length;p++){const m=bn(n,a[p],o);s=$(m.top,s),c=K(m.right,c),d=K(m.bottom,d),u=$(m.left,u)}return{width:c-u,height:d-s,x:u,y:s}}function Dr(e){const{width:n,height:t}=Wn(e);return{width:n,height:t}}function Br(e,n,t){const r=q(n),o=Z(n),i=t==="fixed",a=oe(e,!0,i,n);let l={scrollLeft:0,scrollTop:0};const s=X(0);function c(){s.x=Le(o)}if(r||!r&&!i)if((de(n)!=="body"||he(o))&&(l=Oe(n)),r){const m=oe(n,!0,i,n);s.x=m.x+n.clientLeft,s.y=m.y+n.clientTop}else o&&c();i&&!r&&o&&c();const d=o&&!r&&!i?zn(o,l):X(0),u=a.left+l.scrollLeft-s.x-d.x,p=a.top+l.scrollTop-s.y-d.y;return{x:u,y:p,width:a.width,height:a.height}}function De(e){return W(e).position==="static"}function kn(e,n){if(!q(e)||W(e).position==="fixed")return null;if(n)return n(e);let t=e.offsetParent;return Z(e)===t&&(t=t.ownerDocument.body),t}function Zn(e,n){const t=F(e);if(je(e))return t;if(!q(e)){let o=ee(e);for(;o&&!ae(o);){if(H(o)&&!De(o))return o;o=ee(o)}return t}let r=kn(e,n);for(;r&&Cr(r)&&De(r);)r=kn(r,n);return r&&ae(r)&&De(r)&&!Ye(r)?t:r||Sr(e)||t}const $r=async function(e){const n=this.getOffsetParent||Zn,t=this.getDimensions,r=await t(e.floating);return{reference:Br(e.reference,await n(e.floating),e.strategy),floating:{x:0,y:0,width:r.width,height:r.height}}};function Fr(e){return W(e).direction==="rtl"}const _r={convertOffsetParentRelativeRectToViewportRelativeRect:Pr,getDocumentElement:Z,getClippingRect:Ir,getOffsetParent:Zn,getElementRects:$r,getClientRects:jr,getDimensions:Dr,getScale:se,isElement:H,isRTL:Fr};function Yn(e,n){return e.x===n.x&&e.y===n.y&&e.width===n.width&&e.height===n.height}function Hr(e,n){let t=null,r;const o=Z(e);function i(){var l;clearTimeout(r),(l=t)==null||l.disconnect(),t=null}function a(l,s){l===void 0&&(l=!1),s===void 0&&(s=1),i();const c=e.getBoundingClientRect(),{left:d,top:u,width:p,height:m}=c;if(l||n(),!p||!m)return;const x=be(u),w=be(o.clientWidth-(d+p)),C=be(o.clientHeight-(u+m)),v=be(d),R={rootMargin:-x+"px "+-w+"px "+-C+"px "+-v+"px",threshold:$(0,K(1,s))||1};let b=!0;function S(g){const y=g[0].intersectionRatio;if(y!==s){if(!b)return a();y?a(!1,y):r=setTimeout(()=>{a(!1,1e-7)},1e3)}y===1&&!Yn(c,e.getBoundingClientRect())&&a(),b=!1}try{t=new IntersectionObserver(S,{...R,root:o.ownerDocument})}catch{t=new IntersectionObserver(S,R)}t.observe(e)}return a(!0),i}function Wr(e,n,t,r){r===void 0&&(r={});const{ancestorScroll:o=!0,ancestorResize:i=!0,elementResize:a=typeof ResizeObserver=="function",layoutShift:l=typeof IntersectionObserver=="function",animationFrame:s=!1}=r,c=Ve(e),d=o||i?[...c?fe(c):[],...n?fe(n):[]]:[];d.forEach(v=>{o&&v.addEventListener("scroll",t,{passive:!0}),i&&v.addEventListener("resize",t)});const u=c&&l?Hr(c,t):null;let p=-1,m=null;a&&(m=new ResizeObserver(v=>{let[k]=v;k&&k.target===c&&m&&n&&(m.unobserve(n),cancelAnimationFrame(p),p=requestAnimationFrame(()=>{var R;(R=m)==null||R.observe(n)})),t()}),c&&!s&&m.observe(c),n&&m.observe(n));let x,w=s?oe(e):null;s&&C();function C(){const v=oe(e);w&&!Yn(w,v)&&t(),w=v,x=requestAnimationFrame(C)}return t(),()=>{var v;d.forEach(k=>{o&&k.removeEventListener("scroll",t),i&&k.removeEventListener("resize",t)}),u==null||u(),(v=m)==null||v.disconnect(),m=null,s&&cancelAnimationFrame(x)}}const Ur=wr,zr=vr,Xr=gr,Zr=kr,Yr=xr,Cn=hr,Jr=br,Vr=(e,n,t)=>{const r=new Map,o={platform:_r,...t},i={...o.platform,_c:r};return mr(e,n,{...o,platform:i})};var qr=typeof document<"u",Qr=function(){},Ce=qr?f.useLayoutEffect:Qr;function Me(e,n){if(e===n)return!0;if(typeof e!=typeof n)return!1;if(typeof e=="function"&&e.toString()===n.toString())return!0;let t,r,o;if(e&&n&&typeof e=="object"){if(Array.isArray(e)){if(t=e.length,t!==n.length)return!1;for(r=t;r--!==0;)if(!Me(e[r],n[r]))return!1;return!0}if(o=Object.keys(e),t=o.length,t!==Object.keys(n).length)return!1;for(r=t;r--!==0;)if(!{}.hasOwnProperty.call(n,o[r]))return!1;for(r=t;r--!==0;){const i=o[r];if(!(i==="_owner"&&e.$$typeof)&&!Me(e[i],n[i]))return!1}return!0}return e!==e&&n!==n}function Jn(e){return typeof window>"u"?1:(e.ownerDocument.defaultView||window).devicePixelRatio||1}function En(e,n){const t=Jn(e);return Math.round(n*t)/t}function Be(e){const n=f.useRef(e);return Ce(()=>{n.current=e}),n}function Gr(e){e===void 0&&(e={});const{placement:n="bottom",strategy:t="absolute",middleware:r=[],platform:o,elements:{reference:i,floating:a}={},transform:l=!0,whileElementsMounted:s,open:c}=e,[d,u]=f.useState({x:0,y:0,strategy:t,placement:n,middlewareData:{},isPositioned:!1}),[p,m]=f.useState(r);Me(p,r)||m(r);const[x,w]=f.useState(null),[C,v]=f.useState(null),k=f.useCallback(M=>{M!==g.current&&(g.current=M,w(M))},[]),R=f.useCallback(M=>{M!==y.current&&(y.current=M,v(M))},[]),b=i||x,S=a||C,g=f.useRef(null),y=f.useRef(null),E=f.useRef(d),N=s!=null,A=Be(s),I=Be(o),D=Be(c),j=f.useCallback(()=>{if(!g.current||!y.current)return;const M={placement:n,strategy:t,middleware:p};I.current&&(M.platform=I.current),Vr(g.current,y.current,M).then(T=>{const U={...T,isPositioned:D.current!==!1};P.current&&!Me(E.current,U)&&(E.current=U,Pn.flushSync(()=>{u(U)}))})},[p,n,t,I,D]);Ce(()=>{c===!1&&E.current.isPositioned&&(E.current.isPositioned=!1,u(M=>({...M,isPositioned:!1})))},[c]);const P=f.useRef(!1);Ce(()=>(P.current=!0,()=>{P.current=!1}),[]),Ce(()=>{if(b&&(g.current=b),S&&(y.current=S),b&&S){if(A.current)return A.current(b,S,j);j()}},[b,S,j,A,N]);const B=f.useMemo(()=>({reference:g,floating:y,setReference:k,setFloating:R}),[k,R]),O=f.useMemo(()=>({reference:b,floating:S}),[b,S]),L=f.useMemo(()=>{const M={position:t,left:0,top:0};if(!O.floating)return M;const T=En(O.floating,d.x),U=En(O.floating,d.y);return l?{...M,transform:"translate("+T+"px, "+U+"px)",...Jn(O.floating)>=1.5&&{willChange:"transform"}}:{position:t,left:T,top:U}},[t,l,O.floating,d.x,d.y]);return f.useMemo(()=>({...d,update:j,refs:B,elements:O,floatingStyles:L}),[d,j,B,O,L])}const Kr=e=>{function n(t){return{}.hasOwnProperty.call(t,"current")}return{name:"arrow",options:e,fn(t){const{element:r,padding:o}=typeof e=="function"?e(t):e;return r&&n(r)?r.current!=null?Cn({element:r.current,padding:o}).fn(t):{}:r?Cn({element:r,padding:o}).fn(t):{}}}},eo=(e,n)=>{const t=Ur(e);return{name:t.name,fn:t.fn,options:[e,n]}},no=(e,n)=>{const t=zr(e);return{name:t.name,fn:t.fn,options:[e,n]}},to=(e,n)=>({fn:Jr(e).fn,options:[e,n]}),ro=(e,n)=>{const t=Xr(e);return{name:t.name,fn:t.fn,options:[e,n]}},oo=(e,n)=>{const t=Zr(e);return{name:t.name,fn:t.fn,options:[e,n]}},io=(e,n)=>{const t=Yr(e);return{name:t.name,fn:t.fn,options:[e,n]}},so=(e,n)=>{const t=Kr(e);return{name:t.name,fn:t.fn,options:[e,n]}};var ao="Arrow",Vn=f.forwardRef((e,n)=>{const{children:t,width:r=10,height:o=5,...i}=e;return h.jsx(ne.svg,{...i,ref:n,width:r,height:o,viewBox:"0 0 30 10",preserveAspectRatio:"none",children:e.asChild?t:h.jsx("polygon",{points:"0,0 30,0 15,10"})})});Vn.displayName=ao;var co=Vn;function lo(e){const[n,t]=f.useState(void 0);return G(()=>{if(e){t({width:e.offsetWidth,height:e.offsetHeight});const r=new ResizeObserver(o=>{if(!Array.isArray(o)||!o.length)return;const i=o[0];let a,l;if("borderBoxSize"in i){const s=i.borderBoxSize,c=Array.isArray(s)?s[0]:s;a=c.inlineSize,l=c.blockSize}else a=e.offsetWidth,l=e.offsetHeight;t({width:a,height:l})});return r.observe(e,{box:"border-box"}),()=>r.unobserve(e)}else t(void 0)},[e]),n}var qe="Popper",[qn,Qn]=Nn(qe),[uo,Gn]=qn(qe),Kn=e=>{const{__scopePopper:n,children:t}=e,[r,o]=f.useState(null);return h.jsx(uo,{scope:n,anchor:r,onAnchorChange:o,children:t})};Kn.displayName=qe;var et="PopperAnchor",nt=f.forwardRef((e,n)=>{const{__scopePopper:t,virtualRef:r,...o}=e,i=Gn(et,t),a=f.useRef(null),l=ie(n,a),s=f.useRef(null);return f.useEffect(()=>{const c=s.current;s.current=(r==null?void 0:r.current)||a.current,c!==s.current&&i.onAnchorChange(s.current)}),r?null:h.jsx(ne.div,{...o,ref:l})});nt.displayName=et;var Qe="PopperContent",[po,fo]=qn(Qe),tt=f.forwardRef((e,n)=>{var tn,rn,on,sn,an,cn;const{__scopePopper:t,side:r="bottom",sideOffset:o=0,align:i="center",alignOffset:a=0,arrowPadding:l=0,avoidCollisions:s=!0,collisionBoundary:c=[],collisionPadding:d=0,sticky:u="partial",hideWhenDetached:p=!1,updatePositionStrategy:m="optimized",onPlaced:x,...w}=e,C=Gn(Qe,t),[v,k]=f.useState(null),R=ie(n,ue=>k(ue)),[b,S]=f.useState(null),g=lo(b),y=(g==null?void 0:g.width)??0,E=(g==null?void 0:g.height)??0,N=r+(i!=="center"?"-"+i:""),A=typeof d=="number"?d:{top:0,right:0,bottom:0,left:0,...d},I=Array.isArray(c)?c:[c],D=I.length>0,j={padding:A,boundary:I.filter(ho),altBoundary:D},{refs:P,floatingStyles:B,placement:O,isPositioned:L,middlewareData:M}=Gr({strategy:"fixed",placement:N,whileElementsMounted:(...ue)=>Wr(...ue,{animationFrame:m==="always"}),elements:{reference:C.anchor},middleware:[eo({mainAxis:o+E,alignmentAxis:a}),s&&no({mainAxis:!0,crossAxis:!1,limiter:u==="partial"?to():void 0,...j}),s&&ro({...j}),oo({...j,apply:({elements:ue,rects:ln,availableWidth:Rt,availableHeight:St})=>{const{width:Mt,height:At}=ln.reference,ve=ue.floating.style;ve.setProperty("--radix-popper-available-width",`${Rt}px`),ve.setProperty("--radix-popper-available-height",`${St}px`),ve.setProperty("--radix-popper-anchor-width",`${Mt}px`),ve.setProperty("--radix-popper-anchor-height",`${At}px`)}}),b&&so({element:b,padding:l}),go({arrowWidth:y,arrowHeight:E}),p&&io({strategy:"referenceHidden",...j})]}),[T,U]=it(O),we=Ae(x);G(()=>{L&&(we==null||we())},[L,we]);const vt=(tn=M.arrow)==null?void 0:tn.x,bt=(rn=M.arrow)==null?void 0:rn.y,kt=((on=M.arrow)==null?void 0:on.centerOffset)!==0,[Ct,Et]=f.useState();return G(()=>{v&&Et(window.getComputedStyle(v).zIndex)},[v]),h.jsx("div",{ref:P.setFloating,"data-radix-popper-content-wrapper":"",style:{...B,transform:L?B.transform:"translate(0, -200%)",minWidth:"max-content",zIndex:Ct,"--radix-popper-transform-origin":[(sn=M.transformOrigin)==null?void 0:sn.x,(an=M.transformOrigin)==null?void 0:an.y].join(" "),...((cn=M.hide)==null?void 0:cn.referenceHidden)&&{visibility:"hidden",pointerEvents:"none"}},dir:e.dir,children:h.jsx(po,{scope:t,placedSide:T,onArrowChange:S,arrowX:vt,arrowY:bt,shouldHideArrow:kt,children:h.jsx(ne.div,{"data-side":T,"data-align":U,...w,ref:R,style:{...w.style,animation:L?void 0:"none"}})})})});tt.displayName=Qe;var rt="PopperArrow",mo={top:"bottom",right:"left",bottom:"top",left:"right"},ot=f.forwardRef(function(n,t){const{__scopePopper:r,...o}=n,i=fo(rt,r),a=mo[i.placedSide];return h.jsx("span",{ref:i.onArrowChange,style:{position:"absolute",left:i.arrowX,top:i.arrowY,[a]:0,transformOrigin:{top:"",right:"0 0",bottom:"center 0",left:"100% 0"}[i.placedSide],transform:{top:"translateY(100%)",right:"translateY(50%) rotate(90deg) translateX(-50%)",bottom:"rotate(180deg)",left:"translateY(50%) rotate(-90deg) translateX(50%)"}[i.placedSide],visibility:i.shouldHideArrow?"hidden":void 0},children:h.jsx(co,{...o,ref:t,style:{...o.style,display:"block"}})})});ot.displayName=rt;function ho(e){return e!==null}var go=e=>({name:"transformOrigin",options:e,fn(n){var C,v,k;const{placement:t,rects:r,middlewareData:o}=n,a=((C=o.arrow)==null?void 0:C.centerOffset)!==0,l=a?0:e.arrowWidth,s=a?0:e.arrowHeight,[c,d]=it(t),u={start:"0%",center:"50%",end:"100%"}[d],p=(((v=o.arrow)==null?void 0:v.x)??0)+l/2,m=(((k=o.arrow)==null?void 0:k.y)??0)+s/2;let x="",w="";return c==="bottom"?(x=a?u:`${p}px`,w=`${-s}px`):c==="top"?(x=a?u:`${p}px`,w=`${r.floating.height+s}px`):c==="right"?(x=`${-s}px`,w=a?u:`${m}px`):c==="left"&&(x=`${r.floating.width+s}px`,w=a?u:`${m}px`),{data:{x,y:w}}}});function it(e){const[n,t="center"]=e.split("-");return[n,t]}var xo=Kn,yo=nt,wo=tt,vo=ot,bo="Portal",st=f.forwardRef((e,n)=>{var l;const{container:t,...r}=e,[o,i]=f.useState(!1);G(()=>i(!0),[]);const a=t||o&&((l=globalThis==null?void 0:globalThis.document)==null?void 0:l.body);return a?Pt.createPortal(h.jsx(ne.div,{...r,ref:n}),a):null});st.displayName=bo;function ko(e,n){return f.useReducer((t,r)=>n[t][r]??t,e)}var Ge=e=>{const{present:n,children:t}=e,r=Co(n),o=typeof t=="function"?t({present:r.isPresent}):f.Children.only(t),i=ie(r.ref,Eo(o));return typeof t=="function"||r.isPresent?f.cloneElement(o,{ref:i}):null};Ge.displayName="Presence";function Co(e){const[n,t]=f.useState(),r=f.useRef(null),o=f.useRef(e),i=f.useRef("none"),a=e?"mounted":"unmounted",[l,s]=ko(a,{mounted:{UNMOUNT:"unmounted",ANIMATION_OUT:"unmountSuspended"},unmountSuspended:{MOUNT:"mounted",ANIMATION_END:"unmounted"},unmounted:{MOUNT:"mounted"}});return f.useEffect(()=>{const c=ke(r.current);i.current=l==="mounted"?c:"none"},[l]),G(()=>{const c=r.current,d=o.current;if(d!==e){const p=i.current,m=ke(c);e?s("MOUNT"):m==="none"||(c==null?void 0:c.display)==="none"?s("UNMOUNT"):s(d&&p!==m?"ANIMATION_OUT":"UNMOUNT"),o.current=e}},[e,s]),G(()=>{if(n){let c;const d=n.ownerDocument.defaultView??window,u=m=>{const w=ke(r.current).includes(CSS.escape(m.animationName));if(m.target===n&&w&&(s("ANIMATION_END"),!o.current)){const C=n.style.animationFillMode;n.style.animationFillMode="forwards",c=d.setTimeout(()=>{n.style.animationFillMode==="forwards"&&(n.style.animationFillMode=C)})}},p=m=>{m.target===n&&(i.current=ke(r.current))};return n.addEventListener("animationstart",p),n.addEventListener("animationcancel",u),n.addEventListener("animationend",u),()=>{d.clearTimeout(c),n.removeEventListener("animationstart",p),n.removeEventListener("animationcancel",u),n.removeEventListener("animationend",u)}}else s("ANIMATION_END")},[n,s]),{isPresent:["mounted","unmountSuspended"].includes(l),ref:f.useCallback(c=>{r.current=c?getComputedStyle(c):null,t(c)},[])}}function ke(e){return(e==null?void 0:e.animationName)||"none"}function Eo(e){var r,o;let n=(r=Object.getOwnPropertyDescriptor(e.props,"ref"))==null?void 0:r.get,t=n&&"isReactWarning"in n&&n.isReactWarning;return t?e.ref:(n=(o=Object.getOwnPropertyDescriptor(e,"ref"))==null?void 0:o.get,t=n&&"isReactWarning"in n&&n.isReactWarning,t?e.props.ref:e.props.ref||e.ref)}var Ro=jn[" useInsertionEffect ".trim().toString()]||G;function So({prop:e,defaultProp:n,onChange:t=()=>{},caller:r}){const[o,i,a]=Mo({defaultProp:n,onChange:t}),l=e!==void 0,s=l?e:o;{const d=f.useRef(e!==void 0);f.useEffect(()=>{const u=d.current;u!==l&&console.warn(`${r} is changing from ${u?"controlled":"uncontrolled"} to ${l?"controlled":"uncontrolled"}. Components should not switch from controlled to uncontrolled (or vice versa). Decide between using a controlled or uncontrolled value for the lifetime of the component.`),d.current=l},[l,r])}const c=f.useCallback(d=>{var u;if(l){const p=Ao(d)?d(e):d;p!==e&&((u=a.current)==null||u.call(a,p))}else i(d)},[l,e,i,a]);return[s,c]}function Mo({defaultProp:e,onChange:n}){const[t,r]=f.useState(e),o=f.useRef(t),i=f.useRef(n);return Ro(()=>{i.current=n},[n]),f.useEffect(()=>{var a;o.current!==t&&((a=i.current)==null||a.call(i,t),o.current=t)},[t,o]),[t,r,i]}function Ao(e){return typeof e=="function"}var Po=Object.freeze({position:"absolute",border:0,width:1,height:1,padding:0,margin:-1,overflow:"hidden",clip:"rect(0, 0, 0, 0)",whiteSpace:"nowrap",wordWrap:"normal"}),jo="VisuallyHidden",at=f.forwardRef((e,n)=>h.jsx(ne.span,{...e,ref:n,style:{...Po,...e.style}}));at.displayName=jo;var Oo=at,[Ne]=Nn("Tooltip",[Qn]),Te=Qn(),ct="TooltipProvider",Lo=700,We="tooltip.open",[No,Ke]=Ne(ct),lt=e=>{const{__scopeTooltip:n,delayDuration:t=Lo,skipDelayDuration:r=300,disableHoverableContent:o=!1,children:i}=e,a=f.useRef(!0),l=f.useRef(!1),s=f.useRef(0);return f.useEffect(()=>{const c=s.current;return()=>window.clearTimeout(c)},[]),h.jsx(No,{scope:n,isOpenDelayedRef:a,delayDuration:t,onOpen:f.useCallback(()=>{window.clearTimeout(s.current),a.current=!1},[]),onClose:f.useCallback(()=>{window.clearTimeout(s.current),s.current=window.setTimeout(()=>a.current=!0,r)},[r]),isPointerInTransitRef:l,onPointerInTransitChange:f.useCallback(c=>{l.current=c},[]),disableHoverableContent:o,children:i})};lt.displayName=ct;var me="Tooltip",[To,ge]=Ne(me),dt=e=>{const{__scopeTooltip:n,children:t,open:r,defaultOpen:o,onOpenChange:i,disableHoverableContent:a,delayDuration:l}=e,s=Ke(me,e.__scopeTooltip),c=Te(n),[d,u]=f.useState(null),p=tr(),m=f.useRef(0),x=a??s.disableHoverableContent,w=l??s.delayDuration,C=f.useRef(!1),[v,k]=So({prop:r,defaultProp:o??!1,onChange:y=>{y?(s.onOpen(),document.dispatchEvent(new CustomEvent(We))):s.onClose(),i==null||i(y)},caller:me}),R=f.useMemo(()=>v?C.current?"delayed-open":"instant-open":"closed",[v]),b=f.useCallback(()=>{window.clearTimeout(m.current),m.current=0,C.current=!1,k(!0)},[k]),S=f.useCallback(()=>{window.clearTimeout(m.current),m.current=0,k(!1)},[k]),g=f.useCallback(()=>{window.clearTimeout(m.current),m.current=window.setTimeout(()=>{C.current=!0,k(!0),m.current=0},w)},[w,k]);return f.useEffect(()=>()=>{m.current&&(window.clearTimeout(m.current),m.current=0)},[]),h.jsx(xo,{...c,children:h.jsx(To,{scope:n,contentId:p,open:v,stateAttribute:R,trigger:d,onTriggerChange:u,onTriggerEnter:f.useCallback(()=>{s.isOpenDelayedRef.current?g():b()},[s.isOpenDelayedRef,g,b]),onTriggerLeave:f.useCallback(()=>{x?S():(window.clearTimeout(m.current),m.current=0)},[S,x]),onOpen:b,onClose:S,disableHoverableContent:x,children:t})})};dt.displayName=me;var Ue="TooltipTrigger",ut=f.forwardRef((e,n)=>{const{__scopeTooltip:t,...r}=e,o=ge(Ue,t),i=Ke(Ue,t),a=Te(t),l=f.useRef(null),s=ie(n,l,o.onTriggerChange),c=f.useRef(!1),d=f.useRef(!1),u=f.useCallback(()=>c.current=!1,[]);return f.useEffect(()=>()=>document.removeEventListener("pointerup",u),[u]),h.jsx(yo,{asChild:!0,...a,children:h.jsx(ne.button,{"aria-describedby":o.open?o.contentId:void 0,"data-state":o.stateAttribute,...r,ref:s,onPointerMove:Y(e.onPointerMove,p=>{p.pointerType!=="touch"&&!d.current&&!i.isPointerInTransitRef.current&&(o.onTriggerEnter(),d.current=!0)}),onPointerLeave:Y(e.onPointerLeave,()=>{o.onTriggerLeave(),d.current=!1}),onPointerDown:Y(e.onPointerDown,()=>{o.open&&o.onClose(),c.current=!0,document.addEventListener("pointerup",u,{once:!0})}),onFocus:Y(e.onFocus,()=>{c.current||o.onOpen()}),onBlur:Y(e.onBlur,o.onClose),onClick:Y(e.onClick,o.onClose)})})});ut.displayName=Ue;var en="TooltipPortal",[Io,Do]=Ne(en,{forceMount:void 0}),pt=e=>{const{__scopeTooltip:n,forceMount:t,children:r,container:o}=e,i=ge(en,n);return h.jsx(Io,{scope:n,forceMount:t,children:h.jsx(Ge,{present:t||i.open,children:h.jsx(st,{asChild:!0,container:o,children:r})})})};pt.displayName=en;var ce="TooltipContent",ft=f.forwardRef((e,n)=>{const t=Do(ce,e.__scopeTooltip),{forceMount:r=t.forceMount,side:o="top",...i}=e,a=ge(ce,e.__scopeTooltip);return h.jsx(Ge,{present:r||a.open,children:a.disableHoverableContent?h.jsx(mt,{side:o,...i,ref:n}):h.jsx(Bo,{side:o,...i,ref:n})})}),Bo=f.forwardRef((e,n)=>{const t=ge(ce,e.__scopeTooltip),r=Ke(ce,e.__scopeTooltip),o=f.useRef(null),i=ie(n,o),[a,l]=f.useState(null),{trigger:s,onClose:c}=t,d=o.current,{onPointerInTransitChange:u}=r,p=f.useCallback(()=>{l(null),u(!1)},[u]),m=f.useCallback((x,w)=>{const C=x.currentTarget,v={x:x.clientX,y:x.clientY},k=Ho(v,C.getBoundingClientRect()),R=Wo(v,k),b=Uo(w.getBoundingClientRect()),S=Xo([...R,...b]);l(S),u(!0)},[u]);return f.useEffect(()=>()=>p(),[p]),f.useEffect(()=>{if(s&&d){const x=C=>m(C,d),w=C=>m(C,s);return s.addEventListener("pointerleave",x),d.addEventListener("pointerleave",w),()=>{s.removeEventListener("pointerleave",x),d.removeEventListener("pointerleave",w)}}},[s,d,m,p]),f.useEffect(()=>{if(a){const x=w=>{const C=w.target,v={x:w.clientX,y:w.clientY},k=(s==null?void 0:s.contains(C))||(d==null?void 0:d.contains(C)),R=!zo(v,a);k?p():R&&(p(),c())};return document.addEventListener("pointermove",x),()=>document.removeEventListener("pointermove",x)}},[s,d,a,c,p]),h.jsx(mt,{...e,ref:i})}),[$o,Fo]=Ne(me,{isInside:!1}),_o=_t("TooltipContent"),mt=f.forwardRef((e,n)=>{const{__scopeTooltip:t,children:r,"aria-label":o,onEscapeKeyDown:i,onPointerDownOutside:a,...l}=e,s=ge(ce,t),c=Te(t),{onClose:d}=s;return f.useEffect(()=>(document.addEventListener(We,d),()=>document.removeEventListener(We,d)),[d]),f.useEffect(()=>{if(s.trigger){const u=p=>{const m=p.target;m!=null&&m.contains(s.trigger)&&d()};return window.addEventListener("scroll",u,{capture:!0}),()=>window.removeEventListener("scroll",u,{capture:!0})}},[s.trigger,d]),h.jsx(Dn,{asChild:!0,disableOutsidePointerEvents:!1,onEscapeKeyDown:i,onPointerDownOutside:a,onFocusOutside:u=>u.preventDefault(),onDismiss:d,children:h.jsxs(wo,{"data-state":s.stateAttribute,...c,...l,ref:n,style:{...l.style,"--radix-tooltip-content-transform-origin":"var(--radix-popper-transform-origin)","--radix-tooltip-content-available-width":"var(--radix-popper-available-width)","--radix-tooltip-content-available-height":"var(--radix-popper-available-height)","--radix-tooltip-trigger-width":"var(--radix-popper-anchor-width)","--radix-tooltip-trigger-height":"var(--radix-popper-anchor-height)"},children:[h.jsx(_o,{children:r}),h.jsx($o,{scope:t,isInside:!0,children:h.jsx(Oo,{id:s.contentId,role:"tooltip",children:o||r})})]})})});ft.displayName=ce;var ht="TooltipArrow",gt=f.forwardRef((e,n)=>{const{__scopeTooltip:t,...r}=e,o=Te(t);return Fo(ht,t).isInside?null:h.jsx(vo,{...o,...r,ref:n})});gt.displayName=ht;function Ho(e,n){const t=Math.abs(n.top-e.y),r=Math.abs(n.bottom-e.y),o=Math.abs(n.right-e.x),i=Math.abs(n.left-e.x);switch(Math.min(t,r,o,i)){case i:return"left";case o:return"right";case t:return"top";case r:return"bottom";default:throw new Error("unreachable")}}function Wo(e,n,t=5){const r=[];switch(n){case"top":r.push({x:e.x-t,y:e.y+t},{x:e.x+t,y:e.y+t});break;case"bottom":r.push({x:e.x-t,y:e.y-t},{x:e.x+t,y:e.y-t});break;case"left":r.push({x:e.x+t,y:e.y-t},{x:e.x+t,y:e.y+t});break;case"right":r.push({x:e.x-t,y:e.y-t},{x:e.x-t,y:e.y+t});break}return r}function Uo(e){const{top:n,right:t,bottom:r,left:o}=e;return[{x:o,y:n},{x:t,y:n},{x:t,y:r},{x:o,y:r}]}function zo(e,n){const{x:t,y:r}=e;let o=!1;for(let i=0,a=n.length-1;i<n.length;a=i++){const l=n[i],s=n[a],c=l.x,d=l.y,u=s.x,p=s.y;d>r!=p>r&&t<(u-c)*(r-d)/(p-d)+c&&(o=!o)}return o}function Xo(e){const n=e.slice();return n.sort((t,r)=>t.x<r.x?-1:t.x>r.x?1:t.y<r.y?-1:t.y>r.y?1:0),Zo(n)}function Zo(e){if(e.length<=1)return e.slice();const n=[];for(let r=0;r<e.length;r++){const o=e[r];for(;n.length>=2;){const i=n[n.length-1],a=n[n.length-2];if((i.x-a.x)*(o.y-a.y)>=(i.y-a.y)*(o.x-a.x))n.pop();else break}n.push(o)}n.pop();const t=[];for(let r=e.length-1;r>=0;r--){const o=e[r];for(;t.length>=2;){const i=t[t.length-1],a=t[t.length-2];if((i.x-a.x)*(o.y-a.y)>=(i.y-a.y)*(o.x-a.x))t.pop();else break}t.push(o)}return t.pop(),n.length===1&&t.length===1&&n[0].x===t[0].x&&n[0].y===t[0].y?n:n.concat(t)}var Yo=lt,Jo=dt,Vo=ut,qo=pt,Qo=ft,Go=gt;const Ko=({children:e})=>h.jsx(Yo,{delayDuration:200,children:e}),nn=({content:e,children:n})=>h.jsxs(Jo,{children:[h.jsx(Vo,{asChild:!0,children:n}),h.jsx(qo,{children:h.jsxs(Qo,{className:"z-50 overflow-hidden rounded-md bg-secondary px-3 py-1.5 text-xs text-secondary-foreground",sideOffset:5,children:[e,h.jsx(Go,{className:"fill-secondary",width:8,height:4})]})})]}),ei=({value:e,className:n="",...t})=>h.jsxs("form",{action:"https://codesandbox.io/api/v1/sandboxes/define",method:"POST",target:"_blank",children:[h.jsx("input",{type:"hidden",name:"parameters",value:e}),h.jsx(nn,{content:"Edit example on codesandbox",children:h.jsx("button",{type:"submit",className:`flex cursor-pointer items-center rounded-md p-1.5 text-primary-foreground transition-colors hover:bg-primary ${n}`,...t,children:h.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[h.jsx("path",{d:"M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"}),h.jsx("polyline",{points:"7.5 4.21 12 6.81 16.5 4.21"}),h.jsx("polyline",{points:"7.5 19.79 7.5 14.6 3 12"}),h.jsx("polyline",{points:"21 12 16.5 14.6 16.5 19.79"}),h.jsx("polyline",{points:"3.27 6.96 12 12.01 20.73 6.96"}),h.jsx("line",{x1:"12",y1:"22.08",x2:"12",y2:"12"})]})})})]}),ni=()=>h.jsx("svg",{"aria-hidden":"true",focusable:"false",className:"octicon octicon-mark-github",viewBox:"0 0 24 24",width:"24",height:"24",fill:"currentColor",display:"inline-block",overflow:"visible",children:h.jsx("path",{d:"M12 1C5.923 1 1 5.923 1 12c0 4.867 3.149 8.979 7.521 10.436.55.096.756-.233.756-.522 0-.262-.013-1.128-.013-2.049-2.764.509-3.479-.674-3.699-1.292-.124-.317-.66-1.293-1.127-1.554-.385-.207-.936-.715-.014-.729.866-.014 1.485.797 1.691 1.128.99 1.663 2.571 1.196 3.204.907.096-.715.385-1.196.701-1.471-2.448-.275-5.005-1.224-5.005-5.432 0-1.196.426-2.186 1.128-2.956-.111-.275-.496-1.402.11-2.915 0 0 .921-.288 3.024 1.128a10.193 10.193 0 0 1 2.75-.371c.936 0 1.871.123 2.75.371 2.104-1.43 3.025-1.128 3.025-1.128.605 1.513.221 2.64.111 2.915.701.77 1.127 1.747 1.127 2.956 0 4.222-2.571 5.157-5.019 5.432.399.344.743 1.004.743 2.035 0 1.471-.014 2.654-.014 3.025 0 .289.206.632.756.522C19.851 20.979 23 16.854 23 12c0-6.077-4.922-11-11-11Z"})});function ti({children:e,path:n}){return h.jsxs("div",{className:"flex min-h-0 flex-1 flex-col overflow-hidden rounded-lg border border-border bg-secondary",children:[n&&h.jsx("div",{className:"flex items-center border-b border-border bg-muted px-4 py-2",children:h.jsx("span",{className:"font-mono text-xs text-muted-foreground",children:n})}),h.jsx("div",{className:"min-h-0 w-full flex-1",children:e})]})}const xt=f.forwardRef(({isActive:e,children:n,className:t="",...r},o)=>h.jsx("a",{ref:o,className:`flex cursor-pointer items-center rounded-md p-1.5 text-primary-foreground transition-colors hover:bg-primary ${t}`,...r,children:n}));xt.displayName="Link";const ri=({files:e,template:n="typescript",className:t="",...r})=>h.jsxs("form",{action:"https://stackblitz.com/run",method:"POST",target:"_blank",children:[h.jsx("input",{type:"hidden",name:"project[title]",value:"Joymap Example"}),h.jsx("input",{type:"hidden",name:"project[template]",value:n}),Object.entries(e).map(([o,i])=>i.isBinary?null:h.jsx("input",{type:"hidden",name:`project[files][${o}]`,value:i.content},o)),h.jsx(nn,{content:"Edit example on stackblitz",children:h.jsx("button",{type:"submit",className:`flex cursor-pointer items-center rounded-md p-1.5 text-primary-foreground transition-colors hover:bg-primary ${t}`,...r,children:h.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",width:"24",height:"24",viewBox:"0 0 16 16",children:h.jsx("path",{d:"M7.398 9.091h-3.58L10.364 2 8.602 6.909h3.58L5.636 14l1.762-4.909Z",fill:"currentColor"})})})})]}),oi="/joymap/assets/logo-BXshXfNv.png";var yt={exports:{}};(function(e){var n=function(){var t=String.fromCharCode,r="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",o="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+-$",i={};function a(s,c){if(!i[s]){i[s]={};for(var d=0;d<s.length;d++)i[s][s.charAt(d)]=d}return i[s][c]}var l={compressToBase64:function(s){if(s==null)return"";var c=l._compress(s,6,function(d){return r.charAt(d)});switch(c.length%4){default:case 0:return c;case 1:return c+"===";case 2:return c+"==";case 3:return c+"="}},decompressFromBase64:function(s){return s==null?"":s==""?null:l._decompress(s.length,32,function(c){return a(r,s.charAt(c))})},compressToUTF16:function(s){return s==null?"":l._compress(s,15,function(c){return t(c+32)})+" "},decompressFromUTF16:function(s){return s==null?"":s==""?null:l._decompress(s.length,16384,function(c){return s.charCodeAt(c)-32})},compressToUint8Array:function(s){for(var c=l.compress(s),d=new Uint8Array(c.length*2),u=0,p=c.length;u<p;u++){var m=c.charCodeAt(u);d[u*2]=m>>>8,d[u*2+1]=m%256}return d},decompressFromUint8Array:function(s){if(s==null)return l.decompress(s);for(var c=new Array(s.length/2),d=0,u=c.length;d<u;d++)c[d]=s[d*2]*256+s[d*2+1];var p=[];return c.forEach(function(m){p.push(t(m))}),l.decompress(p.join(""))},compressToEncodedURIComponent:function(s){return s==null?"":l._compress(s,6,function(c){return o.charAt(c)})},decompressFromEncodedURIComponent:function(s){return s==null?"":s==""?null:(s=s.replace(/ /g,"+"),l._decompress(s.length,32,function(c){return a(o,s.charAt(c))}))},compress:function(s){return l._compress(s,16,function(c){return t(c)})},_compress:function(s,c,d){if(s==null)return"";var u,p,m={},x={},w="",C="",v="",k=2,R=3,b=2,S=[],g=0,y=0,E;for(E=0;E<s.length;E+=1)if(w=s.charAt(E),Object.prototype.hasOwnProperty.call(m,w)||(m[w]=R++,x[w]=!0),C=v+w,Object.prototype.hasOwnProperty.call(m,C))v=C;else{if(Object.prototype.hasOwnProperty.call(x,v)){if(v.charCodeAt(0)<256){for(u=0;u<b;u++)g=g<<1,y==c-1?(y=0,S.push(d(g)),g=0):y++;for(p=v.charCodeAt(0),u=0;u<8;u++)g=g<<1|p&1,y==c-1?(y=0,S.push(d(g)),g=0):y++,p=p>>1}else{for(p=1,u=0;u<b;u++)g=g<<1|p,y==c-1?(y=0,S.push(d(g)),g=0):y++,p=0;for(p=v.charCodeAt(0),u=0;u<16;u++)g=g<<1|p&1,y==c-1?(y=0,S.push(d(g)),g=0):y++,p=p>>1}k--,k==0&&(k=Math.pow(2,b),b++),delete x[v]}else for(p=m[v],u=0;u<b;u++)g=g<<1|p&1,y==c-1?(y=0,S.push(d(g)),g=0):y++,p=p>>1;k--,k==0&&(k=Math.pow(2,b),b++),m[C]=R++,v=String(w)}if(v!==""){if(Object.prototype.hasOwnProperty.call(x,v)){if(v.charCodeAt(0)<256){for(u=0;u<b;u++)g=g<<1,y==c-1?(y=0,S.push(d(g)),g=0):y++;for(p=v.charCodeAt(0),u=0;u<8;u++)g=g<<1|p&1,y==c-1?(y=0,S.push(d(g)),g=0):y++,p=p>>1}else{for(p=1,u=0;u<b;u++)g=g<<1|p,y==c-1?(y=0,S.push(d(g)),g=0):y++,p=0;for(p=v.charCodeAt(0),u=0;u<16;u++)g=g<<1|p&1,y==c-1?(y=0,S.push(d(g)),g=0):y++,p=p>>1}k--,k==0&&(k=Math.pow(2,b),b++),delete x[v]}else for(p=m[v],u=0;u<b;u++)g=g<<1|p&1,y==c-1?(y=0,S.push(d(g)),g=0):y++,p=p>>1;k--,k==0&&(k=Math.pow(2,b),b++)}for(p=2,u=0;u<b;u++)g=g<<1|p&1,y==c-1?(y=0,S.push(d(g)),g=0):y++,p=p>>1;for(;;)if(g=g<<1,y==c-1){S.push(d(g));break}else y++;return S.join("")},decompress:function(s){return s==null?"":s==""?null:l._decompress(s.length,32768,function(c){return s.charCodeAt(c)})},_decompress:function(s,c,d){var u=[],p=4,m=4,x=3,w="",C=[],v,k,R,b,S,g,y,E={val:d(0),position:c,index:1};for(v=0;v<3;v+=1)u[v]=v;for(R=0,S=Math.pow(2,2),g=1;g!=S;)b=E.val&E.position,E.position>>=1,E.position==0&&(E.position=c,E.val=d(E.index++)),R|=(b>0?1:0)*g,g<<=1;switch(R){case 0:for(R=0,S=Math.pow(2,8),g=1;g!=S;)b=E.val&E.position,E.position>>=1,E.position==0&&(E.position=c,E.val=d(E.index++)),R|=(b>0?1:0)*g,g<<=1;y=t(R);break;case 1:for(R=0,S=Math.pow(2,16),g=1;g!=S;)b=E.val&E.position,E.position>>=1,E.position==0&&(E.position=c,E.val=d(E.index++)),R|=(b>0?1:0)*g,g<<=1;y=t(R);break;case 2:return""}for(u[3]=y,k=y,C.push(y);;){if(E.index>s)return"";for(R=0,S=Math.pow(2,x),g=1;g!=S;)b=E.val&E.position,E.position>>=1,E.position==0&&(E.position=c,E.val=d(E.index++)),R|=(b>0?1:0)*g,g<<=1;switch(y=R){case 0:for(R=0,S=Math.pow(2,8),g=1;g!=S;)b=E.val&E.position,E.position>>=1,E.position==0&&(E.position=c,E.val=d(E.index++)),R|=(b>0?1:0)*g,g<<=1;u[m++]=t(R),y=m-1,p--;break;case 1:for(R=0,S=Math.pow(2,16),g=1;g!=S;)b=E.val&E.position,E.position>>=1,E.position==0&&(E.position=c,E.val=d(E.index++)),R|=(b>0?1:0)*g,g<<=1;u[m++]=t(R),y=m-1,p--;break;case 2:return C.join("")}if(p==0&&(p=Math.pow(2,x),x++),u[y])w=u[y];else if(y===m)w=k+k.charAt(0);else return null;C.push(w),u[m++]=k+w.charAt(0),p--,k=w,p==0&&(p=Math.pow(2,x),x++)}}};return l}();e!=null?e.exports=n:typeof angular<"u"&&angular!=null&&angular.module("LZString",[]).factory("LZString",function(){return n})})(yt);var ii=yt.exports;const si=Ot(ii),ai="2.2.4",ci={lodash:"^4.17.21"},li={"@ckeditor/ckeditor5-react":"^9.0.0","@types/color-hash":"^1.0.5","@types/lodash":"^4.17.24","@types/react":"^18.3.0","@types/react-dom":"^18.3.0","@types/tinycolor2":"^1.4.6",ckeditor5:"43.3.1","color-hash":"^2.0.2","lorem-ipsum":"^2.0.4",react:"^18.3.0","react-dom":"^18.3.0",tinycolor2:"^1.6.0"},Q={version:ai,dependencies:ci,devDependencies:li},{devDependencies:re,version:di}=Q,ui=[[/^\s*import\s+[A-Za-z_$][\w$]*\s+from\s+['"]@\/public\/assets\/[^'"]+\.(png|jpg|jpeg|svg|webp|gif)['"];?\s*(?:\/\/.*)?$/gm,""],[new RegExp("gamepadUrl","g"),"'https://raw.githubusercontent.com/diegodoumecq/joymap/master/public/assets/gamepad.png'"],[new RegExp("l1Url","g"),"'https://raw.githubusercontent.com/diegodoumecq/joymap/master/public/assets/L1.png'"],[new RegExp("l2Url","g"),"'https://raw.githubusercontent.com/diegodoumecq/joymap/master/public/assets/L2.png'"]];function _(e){return ui.reduce((n,[t,r])=>n.replaceAll(t,r),e)}const xe={isBinary:!1,content:JSON.stringify({compilerOptions:{target:"esnext",module:"commonjs",importHelpers:!0,sourceMap:!0,allowSyntheticDefaultImports:!0,rootDir:"./",lib:["esnext","dom"],strict:!0,alwaysStrict:!0,allowJs:!0,baseUrl:"./",jsx:"react",esModuleInterop:!0}})};function ye({dependencies:e={},devDependencies:n={},hasLodash:t=!0,hasReact:r=!1,reactScripts:o=!1}={}){return JSON.stringify({main:"./index.ts",dependencies:{joymap:Q.version,tslib:"latest",...t?{lodash:Q.dependencies.lodash}:{},...r?{react:Q.devDependencies.react,"react-dom":Q.devDependencies["react-dom"]}:{},...e},devDependencies:{...t?{"@types/lodash":Q.devDependencies["@types/lodash"]}:{},...r?{"@types/react":Q.devDependencies["@types/react"],"@types/react-dom":Q.devDependencies["@types/react-dom"]}:{},...o?{"react-scripts":"latest"}:{parcel:"latest"},...n},...o?{scripts:{start:"react-scripts start",build:"react-scripts build"}}:{}})}function pe(e){const n=JSON.stringify({files:e});return si.compressToBase64(n).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")}const pi=`import { ClassicEditor, Model } from 'ckeditor5/dist';\r
\r
...
`,fi=`import { LoremIpsum } from 'lorem-ipsum';\r
\r
...
`,xi=`import './Editor';\r
`,yi={"Editor.tsx":{content:_(hi),isBinary:!1},"commands.ts":{content:_(fi),isBinary:!1},"custom.css":{content:_(mi),isBinary:!1},"index.ts":{content:_(xi),isBinary:!1},"index.html":{content:gi,isBinary:!1},"ckHelpers.ts":{content:_(pi),isBinary:!1},"package.json":{isBinary:!1,content:ye({hasLodash:!1,hasReact:!0,reactScripts:!0,dependencies:{"@ckeditor/ckeditor5-react":re["@ckeditor/ckeditor5-react"],ckeditor5:re.ckeditor5,"lorem-ipsum":re["lorem-ipsum"]}})},"tsconfig.json":xe},wi=`body {\r
...
`,bi=`import { createJoymap, createQueryModule, Joymap, QueryModule } from 'joymap';\r
...
\r
joymap.start();\r
`,Rn={"index.ts":{content:_(bi),isBinary:!1},"Fighting.css":{content:wi,isBinary:!1},"index.html":{content:vi,isBinary:!1},"package.json":{isBinary:!1,content:ye({hasLodash:!0,hasReact:!1})},"tsconfig.json":xe},ki=`<!doctype html>\r
<html>\r
  <head>\r
    <meta charset="utf-8" />\r
...
\r
let redSprite: HTMLCanvasElement;\r
\r
gamepadImage.onload = () => {\r
  redSprite = createTintedSprite('rgba(255,0,0,0.6)');\r
};\r
\r
