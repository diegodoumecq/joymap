...
`,Pi=`import './Main';
`,Ai=`import React, { useEffect, useState } from 'react';\r
...
root.render(<Main />);\r
`,ji={"index.ts":{content:_(Pi),isBinary:!1},"Main.tsx":{content:_(Ai),isBinary:!1},"Gamepad.tsx":{content:_(Si),isBinary:!1},"index.html":{content:Mi,isBinary:!1},"package.json":{isBinary:!1,content:ye({hasLodash:!1,hasReact:!0,dependencies:{"color-hash":re["color-hash"],tinycolor2:re.tinycolor2},devDependencies:{"@types/color-hash":re["@types/color-hash"],"@types/tinycolor2":re["@types/tinycolor2"]}})},"tsconfig.json":xe},Li=`<!doctype html>\r
<html>\r
  <head>\r
    <meta charset="utf-8" />\r
