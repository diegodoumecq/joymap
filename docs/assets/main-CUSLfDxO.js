...
\r
  ...
  m.setMapper(\r
    'MoveXORPoint',\r
    (module) => !!(module.getMapper<boolean>('Move') !== module.getMapper<boolean>('Point')),\r
  );\r
...
`,Wl=`import { InputResult, MapperResult } from 'joymap';\r
...
\r
export function stringifyMappers(mappers: Record<string, MapperResult>) {\r
  return reduce(\r
    (result, inputName) => {\r
...
//# sourceMappingURL=main-CUSLfDxO.js.map
